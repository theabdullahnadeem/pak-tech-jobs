...
export const metadata: Metadata = {
  title: "DevOps & Cloud Engineer Jobs Pakistan 2026 | PakTechJobs",
  description: "Deploy, scale, and manage infrastructure. Browse DevOps jobs for AWS, Kubernetes, Docker, and CI/CD specialists in Pakistan.",
};

export default function CategoryPage() {
  const jobs = getJobsByCategory("DevOps");
  ...
  return (
    <div className="min-h-screen bg-background pt-24 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16">
          <AffiliateCoursesWidget skill="DevOps & Cloud" />
        </div>
        ...
        <div className="mt-16 bg-surface dark:bg-surface-dark p-8 rounded-2xl border border-border dark:border-border-dark text-sm text-muted">
          <h2 className="text-lg font-bold text-foreground mb-3">About DevOps Engineer Jobs in Pakistan</h2>
          <p>
            Welcome to the premier portal for finding <strong>DevOps & Cloud Engineer Jobs Pakistan 2026 | PakTechJobs</strong>. 
