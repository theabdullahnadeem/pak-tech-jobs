...
export const metadata: Metadata = {
  title: "Frontend Developer Jobs in Pakistan (React, Vue, Angular) | PakTechJobs",
  description: "Explore top frontend developer jobs in Pakistan. Master your UI skills with React, Vue, or Angular and get hired remotely or on-site.",
};

export default function CategoryPage() {
  const jobs = getJobsByCategory("React");
  ...
  return (
    <div className="min-h-screen bg-background pt-24 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16">
          <AffiliateCoursesWidget skill="Frontend Development" />
        </div>
        ...
        <div className="mt-16 bg-surface dark:bg-surface-dark p-8 rounded-2xl border border-border dark:border-border-dark text-sm text-muted">
          <h2 className="text-lg font-bold text-foreground mb-3">About Frontend Developer Jobs in Pakistan</h2>
          <p>
            Welcome to the premier portal for finding <strong>Frontend Developer Jobs in Pakistan (React, Vue, Angular) | PakTechJobs</strong>. 
