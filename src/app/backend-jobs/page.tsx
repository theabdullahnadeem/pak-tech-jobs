...
export const metadata: Metadata = {
  ...
  description: "Backend engineering roles for Node.js, Python, Java, and Go developers in Pakistan. Find scalable server-side opportunities today.",
};

export default function CategoryPage() {
  const jobs = getJobsByCategory("Node.js");
  ...
  return (
    <div className="min-h-screen bg-background pt-24 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16">
          <AffiliateCoursesWidget skill="Backend Engineering" />
        </div>
        ...
        <div className="mt-16 bg-surface dark:bg-surface-dark p-8 rounded-2xl border border-border dark:border-border-dark text-sm text-muted">
          <h2 className="text-lg font-bold text-foreground mb-3">About Backend Engineer Jobs in Pakistan</h2>
          <p>
            Welcome to the premier portal for finding <strong>Backend Developer Jobs in Pakistan 2026 | PakTechJobs</strong>. 
