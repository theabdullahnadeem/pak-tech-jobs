...
export const metadata: Metadata = {
  title: "Tech & IT Jobs in Karachi 2026 | PakTechJobs",
  description: "Looking for an IT job in Karachi? Discover openings for React, MERN, Python, and Software Engineers across top tech companies in Karachi.",
};

export default function CategoryPage() {
  const jobs = getJobsByCategory("Karachi");
    ...
    <div className="min-h-screen bg-background pt-24 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 bg-surface dark:bg-surface-dark p-8 rounded-2xl border border-border dark:border-border-dark text-sm text-muted">
          <h2 className="text-lg font-bold text-foreground mb-3">About IT Jobs & Software Developer Roles in Karachi</h2>
          <p>
            Welcome to the premier portal for finding <strong>Tech & IT Jobs in Karachi 2026 | PakTechJobs</strong>. 
