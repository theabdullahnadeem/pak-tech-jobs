...
export const metadata: Metadata = {
  title: "AI & Machine Learning Engineer Jobs Pakistan 2026 | PakTechJobs",
  description: "Secure a highly sought-after AI and Machine Learning engineering position in Pakistan. Top roles in NLP, Computer Vision, and Generative AI.",
};

export default function CategoryPage() {
  const jobs = getJobsByCategory("Python");
  ...
  return (
    <div className="min-h-screen bg-background pt-24 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16">
          <AffiliateCoursesWidget skill="Artificial Intelligence" />
        </div>
        ...
        <div className="mt-16 bg-surface dark:bg-surface-dark p-8 rounded-2xl border border-border dark:border-border-dark text-sm text-muted">
          <h2 className="text-lg font-bold text-foreground mb-3">About AI & Machine Learning Jobs in Pakistan</h2>
          <p>
            Welcome to the premier portal for finding <strong>AI & Machine Learning Engineer Jobs Pakistan 2026 | PakTechJobs</strong>. 
