...
export const metadata: Metadata = {
  title: "Tech Jobs in Lahore 2026 - Software Houses Hiring | PakTechJobs",
  description: "Browse the latest IT and software engineering jobs in Lahore. Top software houses are actively hiring developers, ML engineers, and designers.",
};

export default function CategoryPage() {
  const jobs = getJobsByCategory("Lahore");
    ...
    <div className="min-h-screen bg-background pt-24 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 bg-surface dark:bg-surface-dark p-8 rounded-2xl border border-border dark:border-border-dark text-sm text-muted">
          <h2 className="text-lg font-bold text-foreground mb-3">About Tech Events & Software Developer Jobs in Lahore</h2>
          <p>
            Welcome to the premier portal for finding <strong>Tech Jobs in Lahore 2026 - Software Houses Hiring | PakTechJobs</strong>. 
