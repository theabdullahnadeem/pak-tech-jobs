...
export const metadata: Metadata = {
  title: "IT Internships & Fresh Graduate Trainee Programs | PakTechJobs",
  description: "Kickstart your tech career. Explore paid software engineering, IT, and developer internships in Lahore, Karachi, and Islamabad.",
};

export default function CategoryPage() {
  const jobs = getJobsByCategory("Intern");
    ...
    <div className="min-h-screen bg-background pt-24 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 bg-surface dark:bg-surface-dark p-8 rounded-2xl border border-border dark:border-border-dark text-sm text-muted">
          <h2 className="text-lg font-bold text-foreground mb-3">About IT & Software Engineering Internships in Pakistan</h2>
          <p>
            Welcome to the premier portal for finding <strong>IT Internships & Fresh Graduate Trainee Programs | PakTechJobs</strong>. 
